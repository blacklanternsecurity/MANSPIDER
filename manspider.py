...
if __name__ == '__main__':
    ...
    parser.add_argument('--dirnames',      nargs='+', default=[],           help='only search directories containing these strings (space-separated)')
    parser.add_argument('--exclude-dirnames', nargs='+', default=[],        help='don\'t search directories containing these strings (space-separated, e.g. `program windows` to exclude Program Files and Windows)')
