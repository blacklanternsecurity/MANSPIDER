...
def main():
    ...
    parser.add_argument('--dc-ip',              default='',                 help='IP Address of the domain controller. If omitted it will use the domain part (FQDN) specified in the target parameter')
    parser.add_argument('--no-pass',            action='store_true',        help='don\'t ask for password (useful for Kerberos authentication with ccache file)')
