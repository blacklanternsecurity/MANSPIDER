...
class MANSPIDER:
    ...
    def process_message(self, message):
        ...
        if self.lockout_threshold():
            self.handle_max_failed_logons()

    # TODO Rename this here and in `process_message`
    def handle_max_failed_logons(self):
    ...
    def lockout_threshold(self):
        ...
        return bool(
            ...
            and (self.failed_logons >= self.max_failed_logons and self.domain)
        )
